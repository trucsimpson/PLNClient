...
namespace PLNClient.Services
{
    ...
    public class MenuService : IMenuService
    {
        public List<MenuItemModel> GetMenuItems(PageType pageType)
        {
            ...
            {
                PageType.Assets => new List<MenuItemModel>
                {
                    new MenuItemModel
                    {
                        SpecialMenu = @"
                ...
                PageType.Divisions => new List<MenuItemModel>
                {
                    new MenuItemModel
                    {
                        SpecialMenu = @"
                ...
                PageType.Houses => new List<MenuItemModel>
                {
                    new MenuItemModel
                    {
                        SpecialMenu = @"
                ...
                PageType.Estimating => new List<MenuItemModel>
                {
                    new MenuItemModel
                    {
                        SpecialMenu = @"
        ...
        private bool IsUrlMatch(string menuUrl, string currentUrl)
        {
            ...
            currentUrl = currentUrl.Trim('/').ToLower();

            if (menuUrl == currentUrl) return true;

            return currentUrl.StartsWith(menuUrl + "/");
        }
    }
}
